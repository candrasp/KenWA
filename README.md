...
> Aplikasi Desktop launcher untuk Broadcast WhatsApp (Tauri v2 · Express.js · Baileys · better-sqlite3 · Vanilla JS SPA)

## Tentang KenWA

KenWA adalah aplikasi desktop launcher modern yang dirancang untuk membantu Anda mengirim pesan massal (blast) WhatsApp dengan mudah melalui web browser, cepat, dan aman. Menggunakan arsitektur Node.js yang ringan dipadukan dengan framework Tauri v2, KenWA menawarkan antarmuka pengguna yang sangat responsif, penggunaan resource komputer yang efisien, dan eksekusi background yang stabil.
