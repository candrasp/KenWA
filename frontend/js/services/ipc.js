...
// ── SSE Bridge for Dev Mode / Real-time Sync ────────────────────────────────
// Pastikan menunjuk ke IP & Port server yang benar
const sse = new EventSource('http://127.0.0.1:3721/api/events');
const sseHandlers = new Set();

sse.onopen = () => console.log('[SSE] Connected to backend events');
sse.onerror = () => console.warn('[SSE] Connection lost. Reconnecting...');
